      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary" style="background: #ffffff; color:#000000">
              ...
              <div class="card-body">
                ...
                @csrf
                  ...
                  <div class="form-group">
                    <div class="d-block">
                      ...
                      <div class="float-right">
                        ...
                        <a href="{{ route('password.request') }}" class="text-small" style="color:#000000 ">
                          Esqueceu sua senha?
                        </a>
                        @endif
                      </div>
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4" style="background: #FF5314; color:#000000">
                      Entrar
                    </button>
                  </div>
                </form>
